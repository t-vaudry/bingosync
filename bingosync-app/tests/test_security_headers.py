...
class SecurityHeadersTestCase(TestCase):
    ...
    def test_content_type_nosniff_header(self):
        ...
        # Django's SecurityMiddleware should set this when
    ...
    def test_csp_settings_configured(self):
        ...
        self.assertEqual(settings.CSP_SCRIPT_SRC,
                         ("'self'", "'unsafe-inline'"))
        ...
        # CSP_CONNECT_SRC includes WebSocket URL, so just verify it exists and
        # contains 'self'
    ...
    def test_secure_cookie_settings(self):
        ...
        # In test mode they may not be set, but we verify they exist in
        # settings.py
    ...
    def test_security_middleware_order(self):
        ...
        self.assertIn(
            'bingosync.middleware.SecurityHeadersMiddleware',
            middleware)
